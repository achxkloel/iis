...
class StudentCourseTableSeeder extends Seeder
{
    ...
    public function createDefaultStudentCourse (): void {
        $student_courses = [
            ...
            ['studentID' => 3, 'courseID' => 2, 'is_active' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['studentID' => 3, 'courseID' => 3, 'is_active' => 1, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['studentID' => 4, 'courseID' => 2, 'is_active' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['studentID' => 4, 'courseID' => 4, 'is_active' => 1, 'created_at' => now(), 'updated_at' => now()],
            ...
            ['studentID' => 5, 'courseID' => 1, 'is_active' => 1, 'created_at' => now(), 'updated_at' => now()],
